...
import { useGLTF, useTexture, Environment, Lightformer, RenderTexture, Text, PerspectiveCamera, Image } from '@react-three/drei';
import {
  BallCollider,
  CuboidCollider,
  Physics,
          ...
          >
            <mesh geometry={nodes.card.geometry}>
              <meshPhysicalMaterial
                ...
                metalness={0.8}
              >
                {/* 覆盖原有的贴图，使用动态 RenderTexture */}
                <RenderTexture attach="map" anisotropy={16}>
                  <PerspectiveCamera makeDefault manual aspect={0.8 / 1.125} position={[0, 0, 5]} />
